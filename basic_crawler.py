...
def main():
    ...
    data_dir = "/Users/mg/Desktop/GitHub/ASTRAL/Code/film_monitoring/Data"
    
    # Read URLs from rough_sitemap.txt in the Data directory
    sitemap_path = os.path.join(data_dir, "rough_sitemap.txt")
    ...
    # Save output to a file in the Data directory
    output_path = os.path.join(data_dir, "basic_crawler_output.txt")
    save_to_file(documents, output_path)
